...
; 0000 0047 // Clock value: 0.977 kHz
; 0000 0048 // Mode: Normal top=0xFF
; 0000 0049 // OC0 output: Disconnected
; 0000 004A // Timer Period: 0.26214 s
; 0000 004B TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (1<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(5)
	OUT  0x33,R30
...
; 0000 0050 // Clock source: T1 pin Falling Edge
...
; 0000 005A TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
; 0000 005B TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (0<<WGM12) | (1<<CS12) | (1<<CS11) | (0<<CS10);
	LDI  R30,LOW(6)
	OUT  0x2E,R30
...
; 0000 0070 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (1<<TOIE0);
	LDI  R30,LOW(1)
	OUT  0x39,R30
; 0000 0071 
...
; 0000 009C // Characters/line: 8
; 0000 009D lcd_init(8);
	LDI  R26,LOW(8)
	RCALL _lcd_init
; 0000 009E 
...
; 0000 00A6         if ( i == 4) {
	...
	CPC  R31,R5
	BRNE _0x6
; 0000 00A7             char arya[3];
; 0000 00A8             lcd_clear();
	SBIW R28,3
;	arya -> Y+0
	RCALL _lcd_clear
; 0000 00A9             itoa(TCNT1L, arya);
	IN   R30,0x2C
	LDI  R31,0
	ST   -Y,R31
	ST   -Y,R30
