...
; 0000 003B // Clock value: 0.977 kHz
; 0000 003C // Mode: CTC top=OCR0
; 0000 003D // OC0 output: Toggle on compare match
; 0000 003E // Timer Period: 0.26214 s
; 0000 003F // Output Pulse(s):
; 0000 0040 // OC0 Period: 0.52429 s Width: 0.26214 s
; 0000 0041 TCCR0=(0<<WGM00) | (0<<COM01) | (1<<COM00) | (1<<WGM01) | (1<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(29)
	OUT  0x33,R30
