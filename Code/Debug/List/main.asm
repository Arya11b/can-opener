...
; 0000 000F     PORTC.2 = 1;
	SBI  0x15,2
; 0000 0010 
; 0000 0011     if (PINC.0 == 0) {
	SBIC 0x13,0
	RJMP _0x9
; 0000 0012         if (PINC.3 == 0) {
	SBIC 0x13,3
	RJMP _0xA
; 0000 0013             lcd_puts("1");
	__POINTW2MN _0xB,0
	RJMP _0x38
; 0000 0014         }else if (PINC.4 == 0) {
_0xA:
	SBIC 0x13,4
	RJMP _0xD
; 0000 0015             lcd_puts("4");
	__POINTW2MN _0xB,2
	RJMP _0x38
; 0000 0016         }else if (PINC.5 == 0) {
_0xD:
	SBIC 0x13,5
	RJMP _0xF
; 0000 0017             lcd_puts("7");
	__POINTW2MN _0xB,4
	RJMP _0x38
; 0000 0018         }else if (PINC.6 == 0) {
_0xF:
	SBIC 0x13,6
	RJMP _0x11
; 0000 0019             lcd_puts("*");
...
; 0000 001F     PORTC.2 = 1;
	SBI  0x15,2
; 0000 0020 
; 0000 0021     if (PINC.1 == 0) {
	SBIC 0x13,1
	RJMP _0x18
; 0000 0022         if (PINC.3 == 0) {
	SBIC 0x13,3
	RJMP _0x19
; 0000 0023             lcd_puts("2");
	__POINTW2MN _0xB,8
	RJMP _0x39
; 0000 0024         }else if (PINC.4 == 0) {
_0x19:
	SBIC 0x13,4
	RJMP _0x1B
; 0000 0025             lcd_puts("5");
	__POINTW2MN _0xB,10
	RJMP _0x39
; 0000 0026         }else if (PINC.5 == 0) {
_0x1B:
	SBIC 0x13,5
	RJMP _0x1D
; 0000 0027             lcd_puts("8");
	__POINTW2MN _0xB,12
	RJMP _0x39
; 0000 0028         }else if (PINC.6 == 0) {
_0x1D:
	SBIC 0x13,6
	RJMP _0x1F
; 0000 0029             lcd_puts("0");
	__POINTW2MN _0xB,14
_0x39:
	RCALL _lcd_puts
; 0000 002A         }
...
; 0000 002F     PORTC.2 = 0;
	CBI  0x15,2
; 0000 0030 
; 0000 0031     if (PINC.2 == 0) {
	SBIC 0x13,2
	RJMP _0x26
; 0000 0032         if (PINC.3 == 0) {
	SBIC 0x13,3
	RJMP _0x27
; 0000 0033             lcd_puts("3");
	__POINTW2MN _0xB,16
	RJMP _0x3A
; 0000 0034         }else if (PINC.4 == 0) {
_0x27:
	SBIC 0x13,4
	RJMP _0x29
; 0000 0035             lcd_puts("6");
	__POINTW2MN _0xB,18
	RJMP _0x3A
; 0000 0036         }else if (PINC.5 == 0) {
_0x29:
	SBIC 0x13,5
	RJMP _0x2B
; 0000 0037             lcd_puts("9");
	__POINTW2MN _0xB,20
	RJMP _0x3A
; 0000 0038         }else if (PINC.6 == 0) {
_0x2B:
	SBIC 0x13,6
	RJMP _0x2D
; 0000 0039             lcd_puts("#");
...
; 0000 0054     DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(7)
	OUT  0x14,R30
; 0000 0055     // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 0056     PORTC=(0<<PORTC7) | (1<<PORTC6) | (1<<PORTC5) | (1<<PORTC4) | (1<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	LDI  R30,LOW(120)
	OUT  0x15,R30
; 0000 0057 
...
; 0000 008C     // INT0: On
; 0000 008D     // INT0 Mode: Rising Edge
; 0000 008E     // INT1: Off
; 0000 008F     // INT2: Off
; 0000 0090     GICR|=(0<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,0x40
	OUT  0x3B,R30
; 0000 0091     MCUCR=(0<<ISC11) | (0<<ISC10) | (1<<ISC01) | (1<<ISC00);
	LDI  R30,LOW(3)
	OUT  0x35,R30
; 0000 0092     MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 0093     GIFR=(0<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(64)
	OUT  0x3A,R30
; 0000 0094 
...
; 0000 00B1     // RS - PORTA Bit 1
; 0000 00B2     // RD - PORTA Bit 2
; 0000 00B3     // EN - PORTA Bit 3
